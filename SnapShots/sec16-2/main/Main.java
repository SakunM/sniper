...
public class Main {
  ...
  private void addUserListenerFor(XMPPConnection connection){
    ui.addListener(new UserListener(){
      @Override public void joinAuction(String itemId){
        snipers.addSniper(Snapshot.joining(itemId));
        Chat chat = connection.getChatManager().createChat(auctionId(itemId), null);
        notToBeGCd.add(chat);
  ...
  public static void main(String... args) throws Exception{
    ...
    main.addUserListenerFor(connection);
  }
}
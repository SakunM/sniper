...
public class XMPPAuction implements Auction {
  ...
  public XMPPAuction(XMPPConnection connection, String itemId, FailureReporter reporter){
    translator = new Translator(connection.getUser(), reporter);
  ...
  @Override public void failed(){ this.chat.removeMessageListener(this.translator);}
}